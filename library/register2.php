         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body" >
                  ...
                  <form  action="checking_register.php" method="post" class="form col-md-15 center-block"> 
                      ...
                      <tbody>
                        ...
                        <td><input type="submit" name="register" value="register" class="btn btn-info"> </td>
                        </tr> 
                      </tbody>
